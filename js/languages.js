const langArr = {
    ...
    de: {
        ...
        "appParagraphFifth": "Kann die Betriebsparameter des Systems flexibel ändern und die Temperatur erhöhen, wenn der Benutzer eine bestimmte Zone im Haus betritt oder sie wieder absenken, wenn er sie verlässt,",
        "appParagraphSixth": "Ermöglicht die Integration beliebig vieler Heizgeräte und ist damit ideal für die Nutzung als Raumtemperatur-Management-System in Wohnungen und Appartements.",
    ...
    ru: {
        ...
        "appParagraphSecond": "Oблегчает управление домом за счет разделения на зоны и установки отдельных параметров работы системы для каждой из них.",
        "appParagraphThird": "Oбеспечивает ощутимые экономические преимущества за счет простой оптимизации энергопотребления для отопления дома - использование готовых графиков или простого планировщика помогает оптимизировать временные и температурные настройки системы без потери теплового комфорта.",
        ...
        "appParagraphSixth": "Mожет гибко изменять рабочие параметры системы и повышать температуру, когда пользователь входит в определенную зону в доме, или снова опускать ее, когда он покидает ее.",
    ...
    it: {
        ...
        "firstSlideSecond": "È un sistema di controllo del riscaldamento dal design innovativo che può essere facilmnte adattato alle tue esigenze, che include una scelta di tre tipi di dispositivi e due tipi di sensori.",
